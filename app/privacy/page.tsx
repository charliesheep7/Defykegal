  ...
  return (
    <SectionContainer>
      <div className="prose dark:prose-invert max-w-none py-8">
        ...
        <p>
          Defy ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy
          explains how we collect, use, and protect your information when you use our mobile
          application or related services ("Services").
        </p>
        <p>
          <strong>If you do not agree with this Privacy Policy, please do not use Defy.</strong>
        </p>
        ...
        <p>Defy is for users 13 years and older.</p>
        <p>
        ...
        <p>
          We may update this Privacy Policy as needed. Continued use of Defy means you accept the
          updated policy.
        </p>
