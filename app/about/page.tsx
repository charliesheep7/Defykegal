...
export const metadata = genPageMetadata({
  title: 'About',
  description:
    'Meet the team behind Defy and learn how our pelvic floor health articles are sourced, attributed, and medically reviewed when indicated.',
})
      ...
      <div className="divide-y divide-gray-800">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <p className="text-lg leading-7 text-gray-400">
            Guided pelvic floor training for men, with health information grounded in cited sources.
          </p>
        </div>
        ...
        <div className="space-y-12 py-10">
          ...
          <section>
            ...
            <p className="mt-4 max-w-3xl leading-relaxed text-gray-400">
              ...
              floor does, why it matters, and how to train it correctly. Articles identify their
              author and publication date. Articles carrying a medical review label also identify
          ...
          <section>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                {
                  title: 'Visible review labels',
                  desc: 'Articles with a medical review label show the reviewer and review date.',
                },
                {
                  title: 'Checkable sources',
                  desc: 'We link to research, clinical guidance, and health institutions so readers can inspect the support for key claims.',
                },
                {
                  title: 'Editorial accountability',
                  desc: 'The editorial team is named on articles, and corrections can be requested through our contact page.',
                },
              ].map((item) => (
